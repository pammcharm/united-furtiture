...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-wd@310bofi3s#e@127dc=$yeb#hoi7a8xpyk$nvkq%i((66d0y')
...
MIDDLEWARE = [
    ...
    'apps.accounts.middleware.ForceAdminPasswordChangeMiddleware',
